...
export default class CheckBox extends Component {
    ...
    genCheckedImage() {
        var source;
        if (this.props.isIndeterminate) {
            source = require('../Images/ic_indeterminate_check_box.png');
        }
        else {
            source = this.state.isChecked ? require('../Images/ic_check_box.png') : require('../Images/ic_check_box_outline_blank.png');
        }
