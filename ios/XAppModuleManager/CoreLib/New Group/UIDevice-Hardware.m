...
/*
 ...
 iPad2,5   ->    (IPAD_MINI_WIFI)
 iPad2,6   ->    (IPAD_MINI)
 iPad2,7   ->    (IPAD_MINI_WIFI_CDMA)
...
{
    NSDictionary *fattributes = [[[NSFileManager alloc] init] attributesOfFileSystemForPath:NSHomeDirectory() error:nil];
...
- (NSString *) platformString
{
    switch ([self platformType])
    {
        ...
        case UIDeviceMiniiPad: return IPAD_MINI_NAMESTRING;
